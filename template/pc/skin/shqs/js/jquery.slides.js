...
(function ($) {
    $.fn.slides = function (option) {
        ...
        return this.each(function () {
            ...
            function animate(direction, effect, clicked) {
                if (!active && loaded) {
                    ...
                    if (option.pagination) {
                        ...
                        $('.carousel-items li a.' + option.currentClass, elem).removeClass(option.currentClass);
                        // add current class to next
                        $('.' + option.paginationClass + ' li:eq(' + next + ')', elem).addClass(option.currentClass);
                        $('.carousel-items li:eq(' + next + ') a.link', elem).addClass(option.currentClass);
                    }
                }
            ...
            $('.carousel-items li:eq(' + start + ') a.link', elem).addClass(option.currentClass);
